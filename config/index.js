export const config = {
  ...
  // 如果你非要填这里也行。脚本也能运行
  APP_ID: "wxa2d68278001e0d12",

  // 公众号APP_SECRET
  // 建议不要填这里，请使用文档中github secret的方法进行保密配置，保护您的隐私安全。
  // 如果你非要填这里也行。脚本也能运行
  APP_SECRET: "36b95dacc5844652b8304c32cb5172bb",
  ...
  USERS: [
    {
      ...
      id: "oM6gy56YlvtOkNHZx1xJ2O8at1rA，oM6gy53jeiJCwgW7aw9DhR-ps3Gg",
      // 你想对他发送的模板消息的模板ID
      useTemplateId: "r7fSy6Ci97FopZlyoyD_M6zr9D2FiMsCf5UvAgPpBCg",
      // 所在省份
      province: "贵州",
      // 所在城市
      city: "贵阳",
      ...
      festivals: [
        ...
        {"type": "节日", "name": "在一起的日子", "year": "2022", "date": "06-23"},
        {"type": "生日", "name": "程", "year": "2002", "date": "10-12"},
      ],
